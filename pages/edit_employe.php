...
<head>
    ...
    <title>Zoo-Arcadia - Editions des employés</title>
            ...
            <div class="card-list-employe mt-3">
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . htmlspecialchars($row['poste']) . " ans</td>";
                        echo "<td>" . htmlspecialchars($row['email']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['statut']) . " kg</td>";
                        echo "<td>" . htmlspecialchars($row['habitat']) . "</td>";                                                             
                        echo "<td><a href='/pages/edit_employe.php'" . $row['id'] . "' class='btn btn-primary btn-sm'>Modifier</a> ";
                        echo "<a href='/pages/supp_empl.php'" . $row['id'] . "' class='btn btn-danger btn-sm'>Supprimer</a></td>";
                        echo "</tr>";
                    }
                } else {
