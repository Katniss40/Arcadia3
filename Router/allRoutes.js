...
export const allRoutes = [
    ...
    new Route("/sante", "sante", "/pages/sante.php", ["admin", "veterinaire"]),
    new Route("/employe", "employe", "/pages/employe.php", ["admin", "employe"]),
    new Route("/gestionE", "employe", "/pages/gestion_employe.php", ["admin"]),
    new Route("/gestionS", "services", "/pages/gestion_service.php", ["admin"]),
    new Route("/gestionA", "animaux", "/pages/gestion_animal.php", ["admin"]),    
